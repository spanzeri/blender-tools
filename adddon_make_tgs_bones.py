...
def register():
    bpy.utils.register_class(SRT_PT_RiggingHelperPanel)
    bpy.utils.register_class(SRT_OT_CreateTargetBone)
    bpy.types.VIEW3D_MT_edit_armature.append(menu_func)
        
        
def unregister():
    bpy.utils.unregister_class(SRT_PT_RiggingHelperPanel)
    bpy.utils.unregister_class(SRT_OT_CreateTargetBone)
